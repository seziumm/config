...
sudo pacman -Syu
sudo pacman -S --noconfirm pacman-contrib ttf-meslo-nerd fastfetch zsh git ripgrep wl-clipboard neovim eza alacritty firefox thunar wofi waybar hyprland hyprpaper unzip zip p7zip yazi man npm nodejs glfw swappy grim slurp wf-recorder htop
#
